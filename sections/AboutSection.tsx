        ...
        <RoughNotationGroup>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start md:grid grid-cols-5 gap-8">
            ...
            <p className="col-start-1 col-end-3 md:col-start-3 md:col-end-6 row-start-4 row-end-6 lg:row-start-2 lg:row-end-3 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              Hai, Aku{" "}
              <a href="https://instagram.com/doniisgh" target="_blank" rel="noopener">
                Doni
              </a>
              👋🏼, Seorang pelajar kelas 3 SMA yang memiliki ketertarikan dengan
              dunia design (Proficient) dan copywriting (Excited) 
              <br />
              Sebagai seorang pelajar yang memiliki sifat penasaran (Suka Hal Baru) saya
              selalu mencari hal baru jika bagi saya hal tersebut mampu saya lakukan,
              hasil design yang telah saya buat saya upload di{" "}
              <a href="https://instagram.com/earthwide.std" target="_blank" rel="noopener">
                Instagram
              </a>
              , dan
              untuk Copywriting saya masih mempelajari hal tersebut lebih mendalam
              saya sedang mencari
              <br />
              orang pertama yang mau menggunakan jasa copywriting saya
              secara gratis sebagaimana saya sedang mengisi untuk portofolio saya.
            </p>
          </div>
        </RoughNotationGroup>
      </section>
